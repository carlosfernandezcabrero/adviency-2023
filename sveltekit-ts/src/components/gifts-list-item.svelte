...
<li class="flex items-center p-4 border border-gray-200 rounded shadow-sm gap-x-12">
		...
		<span class="flex items-center gap-x-2">
			...
			>
				<svg
					...
					fill="currentColor"
					class="stroke-[4] size-4"
					viewBox="0 0 24 24"
				>
					<path
						d="M21.731 2.269a2.625 2.625 0 0 0-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 0 0 0-3.712Zm-2.218 5.93-3.712-3.712-12.15 12.15a5.25 5.25 0 0 0-1.32 2.214l-.8 2.685a.75.75 0 0 0 .933.933l2.685-.8a5.25 5.25 0 0 0 2.214-1.32L19.513 8.2Z"
					/>
				</svg>
			</button>
			<button
			...
			<button class="danger" on:click={handleDeleteGift} aria-label="borrar" type="button">
				<svg
					xmlns="http://www.w3.org/2000/svg"
					fill="none"
					stroke="currentColor"
